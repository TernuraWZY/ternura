...
- Use web_search to discover relevant public pages when no concrete URL is available. Treat snippets as hints, then use web_fetch to inspect sources before relying on factual claims. Cite fetched source URLs.
